...
const ideas = [
  ...
  },
  {
    ...
    description: "Track workouts, set goals, and share progress with friends.",
    techStack: ["React Native", "Firebase", "Chart.js"]
  },
  {
    title: "E-commerce Site with AR Try-On",
    category: "eCommerce / AR",
    description: "An online store that lets users virtually try on products using AR.",
    techStack: ["Next.js", "Three.js", "WebXR", "Stripe API"]
  },
  {
    title: "AI-Powered Writing Assistant",
    category: "AI / Productivity",
    description: "A web app that helps improve writing by suggesting grammar, style, and tone improvements.",
